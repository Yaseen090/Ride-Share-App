...
public class FoodDeliveryHomeFragment extends BaseFragment implements GetAddressFromLocation.AddressFound, GetLocationUpdates.LocationUpdates, AppBarLayout.OnOffsetChangedListener, SwipeRefreshLayout.OnRefreshListener,  IOnBackPressed {
...
//
//            bn.putBoolean("IS_NEW", generalFunc.getJsonValue("LastOrderFoodDetailRatingShow", userProfileJson).equalsIgnoreCase("Yes"));
//
...
//                            map.put("vImage", vImage);
    ...
    public void onResume() {
        super.onResume();
        MyUtils.getLanguageLabelServiceWise(generalFunc, generalFunc.retrieveValue("DEFAULT_SERVICE_CATEGORY_ID"));
        try {
            ...
            if (!isProfilefrg && !isWalletfrg && !isBookingfrg) {
