...
//            }
            ...
            if (resultCode == Activity.RESULT_OK) {
                ...
                if (mainAct != null && mainAct.isMenuImageShow) {
                    menuImgView.setVisibility(View.GONE);
                    menuBtn.setVisibility(View.GONE);
                    backImgView.setVisibility(View.VISIBLE);
                    backBtn.setVisibility(View.VISIBLE);
                ...
                Status status = PlaceAutocomplete.getStatus(getActivity(), data);
                generalFunc.showMessage(generalFunc.getCurrentView(getActivity()), status.getStatusMessage());
    ...
    private void addSourceOrDestAddress(boolean isDestination, Intent data, boolean routeDraw) {
        ...
        if (isDestination) {
            ...
            if (mainAct != null && mainAct.stopOverPointsList.size() >= 1) {
