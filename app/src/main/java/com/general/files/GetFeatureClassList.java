...
public class GetFeatureClassList {
    ...
    public static HashMap<String, String> getAllGeneralClasses() {
        ...
        // Only BSR files
        rentItemClassList.add(BuildConfig.APPLICATION_ID + ".rentItem.fragment.RentItemListFragment");
        ...
        trackServiceClassList.add(BuildConfig.APPLICATION_ID + ".trackService.PairCodeGenrateActivity");
