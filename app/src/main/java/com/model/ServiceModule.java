...
public class ServiceModule {
    ...
    public static void configure() {
        ...
        ServiceModule.OnlyRideSharingPro = generalFun.getJsonValueStr("ENABLE_RIDE_SHARING_PRO", USER_PROFILE_JSON).equalsIgnoreCase("Yes") &&
                generalFun.getJsonValueStr("ONLY_ENABLE_RIDE_SHARING_PRO", USER_PROFILE_JSON).equalsIgnoreCase("Yes");
