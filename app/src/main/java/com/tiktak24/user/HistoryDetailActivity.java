...
public class HistoryDetailActivity extends ParentActivity {
    ...
    /* Fav Driver variable declaration start */ LinearLayout favArea;
...
//
    ...
    public void setData(String tripData) {
        ...
        ((MTextView) findViewById(R.id.tripdateVTxt)).setText(generalFunc.convertNumberWithRTL(generalFunc.getDateFormatedType(generalFunc.getJsonValue("dBooking_dateOrig", tripData), Utils.OriginalDateFormate, CommonUtilities.BookingDateTimeFormat))+ " " +generalFunc.retrieveLangLBl("", "LBL_AT_TEXT") + " " +generalFunc.convertNumberWithRTL(generalFunc.getDateFormatedType(generalFunc.getJsonValue("dBooking_dateOrig", tripData), Utils.OriginalDateFormate, CommonUtilities.OriginalTimeFormate))/*generalFunc.convertNumberWithRTL(generalFunc.getDateFormatedType(generalFunc.getJsonValue("dBooking_dateOrig", tripData), Utils.OriginalDateFormate, Utils.getDetailDateFormat(getActContext())))*/);
