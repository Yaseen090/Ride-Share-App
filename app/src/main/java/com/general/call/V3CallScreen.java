...
public class V3CallScreen extends ParentActivity implements V3CallListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        requestPermissions = MyApp.getInstance().checkCameraWithMicPermission(dataProvider != null && dataProvider.isVideoCall, CommunicationManager.MEDIA_TYPE == CommunicationManager.MEDIA.TWILIO);
    ...
    private void inti() {
        ...
        String toMemberImage = dataProvider != null ? dataProvider.toMemberType : "";
        String toMemberId = dataProvider != null ? dataProvider.callId : "";
        ivAvatar = findViewById(R.id.ivAvatar);
        if (isIncomingView) {
            if (dataProvider != null && dataProvider.fromMemberType != null && dataProvider.fromMemberId != null) {
                toMemberImage = dataProvider.fromMemberType;
                toMemberId = dataProvider.fromMemberId;
            }
        }
        if (dataProvider != null && Utils.checkText(dataProvider.toMemberImage)) {
        ...
        txtToMemberName.setText(dataProvider != null ? dataProvider.toMemberName : "");
    ...
    private void intiCallingView() {
        ...
        if (dataProvider != null && dataProvider.isVideoCall) {
    ...
    private class UpdateCallDurationTask extends TimerTask {
        ...
        @Override
        public void run() {
            if (V3CallScreen.this.isFinishing()) {
                if (V3CallScreen.this.mDurationTask != null) {
                    V3CallScreen.this.mDurationTask.cancel();
                }
                if (V3CallScreen.this.mTimer != null) {
                    V3CallScreen.this.mTimer.cancel();
                }
                return;
            }
            runOnUiThread(() -> {
