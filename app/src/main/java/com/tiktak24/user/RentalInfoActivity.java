...
public class RentalInfoActivity extends ParentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        noteMsgTxt.setBackgroundColor(getResources().getColor(R.color.cardView23ProBG));
        noteMsgTxt.getSettings().setUseWideViewPort(true);
        noteMsgTxt.getSettings().setLoadWithOverviewMode(true);
        noteMsgTxt.getSettings().setTextZoom(350);
    ...
    public void setLabel() {
        ...
        WeViewFontConfig.FONT_COLOR = "#707070";
        WeViewFontConfig.FONT_SIZE = "12px";
