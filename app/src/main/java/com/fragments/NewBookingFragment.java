                    ...
                    if (arr_rides != null) {
                        ...
                        if (arr_rides.length() > 0) {
                            ...
                            for (int i = 0; i < arrRidesSize; i++) {
                                ...
                                try {
                                    map.put("ConvertedTripRequestDate", generalFunc.convertNumberWithRTL(generalFunc.getDateFormatedType(dBooking_dateOrig, Utils.OriginalDateFormate, CommonUtilities.BookingDateTimeFormat)));
